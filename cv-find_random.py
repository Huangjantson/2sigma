...
def manager_skill_eval(train_df,test_df,k,g=1,f=1,random = None,update_df =None):
    ...
    temp['manager_skill_origin'] = temp['ManHigh']*2 + temp['ManMedium']
...
g = 10
random_list = [0.1,0.03,0.01]

result_file = cv_random.log
...
for random in random_list:
    ...
    #====================================================================        
            ...
            for train,test in skf:
                manager_skill_eval(dev_set.iloc[train,:],dev_set.iloc[test,:],k=5,g=g,random = random,update_df = dev_set)
                
            #val set adding manager skill
            manager_skill_eval(dev_set,val_set,k=5,g=g,random = random)
            ...
            for f in categorical:
                ...
                if dev_set[f].dtype=='object':
    				...
    				#==================testing the para for smoothing manager============
    ...
    try:
        ...
        f.write('the cv-score for random parameter with value '\
        +str(random)+' is: '\
        +str(cv_scores)+'\n')
