...
def hcc_scoring(train_df,test_df,feature,labelValue,update_df =None,randomize = 0.1):    
...
#fill the categorical feature
train_df,test_df  = singleValueConvert(train_df,test_df,'manager_id',15)
train_df,test_df  = singleValueConvert(train_df,test_df,'building_id',15)
